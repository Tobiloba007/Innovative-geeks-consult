             ...
             whileHover={{
              ...
              className="services-main-con">
                ...
                <div className="services-main-bottom">
                    <p className='services-main-title'>{services.serTitle1}</p>
            ...
            <motion.div
             whileHover={{
              ...
              className="services-main-con">
                ...
                <div className="services-main-bottom">
                    <p className='services-main-title'>{services.serTitle2}</p>
            ...
            <motion.div
             whileHover={{
              ...
              className="services-main-con">
                ...
                <div className="services-main-bottom">
                    <p className='services-main-title'>{services.serTitle3}</p>
            ...
            <motion.div
             whileHover={{
              ...
              className="services-main-con">
                ...
                <div className="services-main-bottom">
                    <p className='services-main-title'>{services.serTitle4}</p>
            ...
            <motion.div
             whileHover={{
              ...
              className="services-main-con">
                ...
                <div className="services-main-bottom">
                    <p className='services-main-title'>{services.serTitle5}</p>
                    <div  className='services-main-icon'><BiHotel /></div>
                    <motion.button 
                    whileHover={{
                        scale: 1.05,
            ...
            <motion.div
             whileHover={{
              ...
              className="services-main-con">
                ...
                <div className="services-main-bottom">
                    <p className='services-main-title'>{services.serTitle6}</p>
