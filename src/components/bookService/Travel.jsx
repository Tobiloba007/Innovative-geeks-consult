    ...
    <div>
        ...
        <div className="book-main-con">
            <div className="book-main-left">
                <h1 className='book-main-left-title'>{travel.serTitle6}</h1>
                ...
                <p className='book-main-left-words'>{travel.serTexts6} </p>
