    ...
    <div>
        ...
        <div className="book-main-con">
            <div className="book-main-left">
                <h1 className='book-main-left-title'>{ticketing.serTitle4}</h1>
                <img className='book-main-left-img'
                src="https://images.unsplash.com/photo-1578575436955-ef29da568c6c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8dGlja2V0c3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" alt="" />
                <p className='book-main-left-words'>{ticketing.serTexts4} </p>
