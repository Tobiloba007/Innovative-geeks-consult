    ...
    <div>
        ...
        <div className="book-main-con">
            <div className="book-main-left">
                <h1 className='book-main-left-title'>{study.serTitle2}</h1>
                <img className='book-main-left-img'
                src="https://images.pexels.com/photos/935948/pexels-photo-935948.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
                <p className='book-main-left-words'>{study.serTexts2}</p>
            ...
            <div className='book-main-right-bottom'>
                ...
                <div className='book-main-right-bottom-content'>
                    ...
                    <p className='book-main-right-bottom-content-2'>
                       <BsPhoneVibrateFill className='bottom-content-icon' /> {study.phone2}
                    </p>
