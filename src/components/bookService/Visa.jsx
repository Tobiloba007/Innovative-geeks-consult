    ...
    <div>
        ...
        <div className="book-main-con">
            <div className="book-main-left">
                <h1 className='book-main-left-title'>{visa.serTitle3}</h1>
                <img className='book-main-left-img'
                src="https://images.unsplash.com/photo-1565535941810-e9892acd7704?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTB8fHZpc2F8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" alt="" />
                <p className='book-main-left-words'>{visa.serTexts3}</p>
            ...
            <div className='book-main-right-bottom'>
                ...
                <div className='book-main-right-bottom-content'>
                    ...
                    <p className='book-main-right-bottom-content-2'>
                       <BsPhoneVibrateFill className='bottom-content-icon' />{visa.phone2}
                    </p>
